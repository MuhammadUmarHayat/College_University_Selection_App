...
public class AdminAddInstitute extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_admin_add_institute);

        etInstituteNames1 =findViewById(R.id.AdminetInstituteNames);
        etInstituteLink1 =findViewById(R.id.AdminetInstituteLink);
        etInstCity1 =findViewById(R.id.AdminetInstCity);
        etInsAddress1 =findViewById(R.id.AdminetInsAddress);
        spInstMedium1  =findViewById(R.id.AdminspInstMedium);//spInstLevel

        spInstLevel1  =findViewById(R.id.AdminspInstLevel);//
        btnSave =findViewById(R.id.AdminbtnInsSave);
        btnBack =findViewById(R.id.AdminbtnInsBacks);
        mgr1NameTv1=findViewById(R.id.Adminmgr1NameTv2);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent page = new Intent(AdminAddInstitute.this, Admin.class);
                startActivity(page);
            }
        });
        ...
        btnSave.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    if (inserted > 0) {
                        Toast.makeText(AdminAddInstitute.this, "Record is saved", Toast.LENGTH_SHORT).show();
                ...
                {
                    Toast.makeText(AdminAddInstitute.this, "error"+exp.getMessage().toString(), Toast.LENGTH_SHORT).show();
