...
public class AdminBoysList extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_boys_list);
        dbMain=new MyDBHelper(this);
        btninslistBack1=findViewById(R.id.btninslistBackBoys);
        id=new ArrayList<>();
        name=new ArrayList<>();
        ...
        recyclerView= findViewById(R.id.AdminrecyclerViewAllInstitutesBoys);
        ...
        btninslistBack1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(AdminBoysList.this, Admin.class);
