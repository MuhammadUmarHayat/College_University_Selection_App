...
public class UniversityList extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btninslistBack1=findViewById(R.id.btninslistBackUniMain);
        id=new ArrayList<>();
        name=new ArrayList<>();
        ...
        recyclerView= findViewById(R.id.AdminrecyclerViewAllInstitutesUniMain);
        ...
        btninslistBack1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(UniversityList.this, MainActivity.class);
    ...
    private void displayData()
    {
        ...
        Cursor cursor = dbMain.getInstitutelevel(level);
