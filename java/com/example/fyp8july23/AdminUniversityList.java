...
public class AdminUniversityList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btninslistBack1=findViewById(R.id.btninslistBackUni);
        id=new ArrayList<>();
        name=new ArrayList<>();
        ...
        recyclerView= findViewById(R.id.AdminrecyclerViewAllInstitutesUni);
        ...
        btninslistBack1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(AdminUniversityList.this, Admin.class);
