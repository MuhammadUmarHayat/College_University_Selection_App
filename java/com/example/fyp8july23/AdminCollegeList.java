...
public class AdminCollegeList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_admin_college_list);
        ...
        recyclerView= findViewById(R.id.AdminrecyclerViewAllInstitutes);
        ...
        btninslistBack1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(AdminCollegeList.this, Admin.class);
    ...
    private void displayData()
    {
        ...
        String level="Collage";
        Cursor cursor = dbMain.getInstitutelevel(level);//dbMain.getTableData("institutes","level","Collage");//getAllData("institutes");
