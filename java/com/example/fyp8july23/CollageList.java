...
public class CollageList extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btninslistBack1=findViewById(R.id.btninslistBackMain);
        id=new ArrayList<>();
        name=new ArrayList<>();
        ...
        recyclerView= findViewById(R.id.AdminrecyclerViewAllInstitutesMain);
        ...
        btninslistBack1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(CollageList.this, MainActivity.class);
